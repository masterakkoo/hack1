            ...
            <div className='contact'>
                ...
                <div className='right-cont'>
                    ...
                    <form  >
                        ...
                        <div className='subject'><label for="subject">password:</label>
                            <input type='text' name="passwords" placeholder='passwords' onChange={Handle} value={user.subject}></input></div>
